...
export const profile = {
  ...
  email: "jenna.ficula@gmail.com",
  location: "",
  linkedin: "https://linkedin.com/in/JennaFicula",
  resume: "/Jenna_Ficula_2026_Solutions.pdf",
  tagline: "Innovating Client Solutions with AI & Emerging Tech",
  bio: `Hi i'm Jenna Ficula! I am a software engineer and solutions consultant building at the intersection of AI, emerging tech, and real-world enterprise impact.
...
export const projects = [
    ...
    subtitle: "Unitree H1-2 · NVIDIA IsaacSim · IsaacLab · Imitation Learning · Reinforcement Learning · Gemini Robotics",
    year: "2025",
    description:
...
The outcome was that defect identification that previously required manual visual inspection got fully automated — reducing the time from production to quality flag significantly, improving worker safety, and giving the client complete traceability across the manufacturing line.`,
  ...
  },
  {
    ...
    subtitle: "Unity · AWS Rekognition · AWS Bedrock · Magic Leap 2 · Ericsson Private 5G · DISC Profiling",
    year: "2024",
    description:
